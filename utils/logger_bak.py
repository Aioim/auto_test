...
perf_logger = LazyLogger.get("performance", log_level="DEBUG", log_to_console=False)
security_logger = LazyLogger.get("security", log_level="INFO", log_to_console=False)
api_logger = LazyLogger.get("api", log_level="DEBUG", log_to_console=False)
